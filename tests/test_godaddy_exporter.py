...
class GoDaddyExporterTests(unittest.TestCase):
    def test_writes_valid_new_import_row_with_expected_columns(self) -> None:
        ...
        self.assertEqual(row["MSRP"], "600")
        self.assertEqual(row["BRAND"], "Sample Brand")
        self.assertEqual(row["STATUS"], "ACTIVE")
        self.assertEqual(row["PRICE"], "525")
        self.assertEqual(row["SALE PRICE"], "500.5")
        self.assertEqual(row["UNIT COST"], "400")
        ...
        self.assertEqual(row["FIXED SHIPPING FEE"], "12.3")
